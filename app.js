...
export default function BrandGenApp() {
  ...
  const handleSliderChange = (key, val) => {
    ...
    setActivePreset(null); // Clear preset if user modifies manually
  };
...
Instructions: ${imageInstructions}`;
  ...
  const handleSingleRegenerate = (id) => {
    ...
    setTimeout(() => {
       ...
       // For demo, we just force a re-render by creating a new ID but keeping type
  ...
  const renderStep3 = () => (
    <div className="animate-in fade-in slide-in-from-right-4 duration-300 h-full flex flex-col pb-20">
      <div className="flex-grow grid grid-cols-1 min-[700px]:grid-cols-4 h-[calc(100vh-140px)]">
        ...
        {/* Left: Quick Styles List (25% width) */}
        ...
        {/* Right: Custom Configuration (75% width) */}
        {/* Removed box styling, added independent scrolling and dividing line */}
